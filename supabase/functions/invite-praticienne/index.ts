// =====================================================
// SANCTUARYS · Edge Function · invite-praticienne
// Invitation des praticien.nes externes à Sanctuarys Outils
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (callerProfile?.role !== 'admin') {
      return json({ error: 'Seule l\'administratrice peut inviter des praticien.nes' }, 403)
    }
    ...
    // Invitation Supabase Auth, redirection vers outils.html
    ...
    console.error('invite-praticienne error:', err)
